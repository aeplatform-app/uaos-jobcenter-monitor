...
"UAOS V8 PASS $(Get-Date)`nBACKEND $($b.StatusCode)`nFRONTEND $($f.StatusCode)`nReady: presets, payments placeholders, launch checklist, release report" | Set-Content "agent-output\UAOS_V8_STATUS.txt"
Start-Process "http://127.0.0.1:5180"
notepad "agent-output\UAOS_V8_STATUS.txt"
